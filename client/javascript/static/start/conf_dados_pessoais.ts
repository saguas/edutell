...
module MConfigDadosPessoais{

	export class CConfigDadosPessoais {
  ...
  Session.set("dadosPessoais",false);
	...
	Template.config_dados_pessoais.rendered = function() {
      ...
      if(!this.handleEdit){
            ...
            this.handleEdit = disableFormElemnt();
        }
        $('a[data-toggle="pill"]').on('show', function (e) {
            ...
            return validacao_form.verificarForm($(".form-horizontal"));
    ...
    Template.config_dados_pessoais.events({
        'click #btnform': function(event, tmpl) {
                ...
                if(validacao_form.verificarForm($(tmpl.find(".form-horizontal")))){
